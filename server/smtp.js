...
Meteor.startup(function () {
  ...
  process.env.MAIL_URL = 'smtp://your_username:your_password@smtp.googlemail.com:25';
});//Meteorsmtp.port; 
  //process.env.MAIL_URL = 'smtp://your_username:your_password@smtp.gmail.com:25';smtp.port; 
